package com.arllain.algashop.ordering.domain.exception;

import com.arllain.algashop.ordering.domain.entity.OrderStatus;
import com.arllain.algashop.ordering.domain.valueobject.id.OrderId;

import static com.arllain.algashop.ordering.domain.exception.ErrorMessages.ERROR_ORDER_STATUS_CANNOT_BE_CHANGED;
