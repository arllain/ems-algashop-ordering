...
public class Order {
    ...
    public LocalDate expectedDeliveryData() {
    ...
    private void setExpectedDeliveryData(LocalDate expectedDeliveryData) {
        this.expectedDeliveryData = expectedDeliveryData;
    }
